...
class ExcelService
{
    ...
    public function proceedExcel($file) {
        ...
        // я не робив саме для цього файлу оптимізацію по меморі,бо мені написав меморі юседж 36мб,що не є багато. якби це було необхідно-зробив би flush репозиторію для продуктів
